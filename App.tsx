...
// --- Constants ---
// Switched to Flash models which are generally available without paid billing profiles
  ...
  const generateImage = async (beat: Beat, type: ComicFace['type']): Promise<string> => {
    ...
    try {
        ...
        const res = await ai.models.generateContent({
          model: MODEL_IMAGE_GEN_NAME,
          contents: contents,
          // '3:4' is a standard supported vertical aspect ratio for Flash Image. 
          // '2:3' is not typically supported by Flash Image directly.
